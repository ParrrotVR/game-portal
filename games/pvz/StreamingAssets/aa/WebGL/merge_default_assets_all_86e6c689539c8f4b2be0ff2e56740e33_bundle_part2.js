...
(async () => {
  try {
    ...
    // Merge default_assets_all_86e6c689539c8f4b2be0ff2e56740e33.bundle.part2
    const fileParts = getParts("default_assets_all_86e6c689539c8f4b2be0ff2e56740e33.bundle.part2", 1, 4);
    const mergedUrl = await mergeFiles(
      fileParts, 
      "default_assets_all_86e6c689539c8f4b2be0ff2e56740e33.bundle.part2", 
      (progress, filename) => {
    ...
    XMLHttpRequest.prototype.open = function(method, url, ...rest) {
      if (url.includes("default_assets_all_86e6c689539c8f4b2be0ff2e56740e33.bundle.part2")) {
        url = mergedUrl;
      }
