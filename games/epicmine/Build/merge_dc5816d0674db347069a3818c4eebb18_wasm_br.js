...
(async () => {
  try {
    ...
    // Merge dc5816d0674db347069a3818c4eebb18.wasm.br
    const fileParts = getParts("dc5816d0674db347069a3818c4eebb18.wasm.br", 1, 8);
    ...
    XMLHttpRequest.prototype.open = function(method, url, ...rest) {
      if (url.includes("dc5816d0674db347069a3818c4eebb18.wasm.br")) {
        url = mergedUrl;
      }
