...
// File merging script for epicmine
...
// Initialize merging for epicmine
(async () => {
  try {
    // Update loading text
    ...
    // Merge f3f6b0ef131f67204364f79b8ba5fb91.data.br
    const fileParts = getParts("f3f6b0ef131f67204364f79b8ba5fb91.data.br", 1, 5);
    ...
    XMLHttpRequest.prototype.open = function(method, url, ...rest) {
      if (url.includes("f3f6b0ef131f67204364f79b8ba5fb91.data.br")) {
        url = mergedUrl;
      }
