...
// File merging script for carcrash
...
// Initialize merging for carcrash
(async () => {
  try {
    // Update loading text
    ...
    // Merge e43293bd67a34c9d37457957d30ba781.data.unityweb
    const fileParts = getParts("e43293bd67a34c9d37457957d30ba781.data_parts/e43293bd67a34c9d37457957d30ba781.data.unityweb", 1, 4);
    const mergedUrl = await mergeFiles(
      fileParts, 
      "e43293bd67a34c9d37457957d30ba781.data.unityweb", 
      (progress, filename) => {
    ...
    XMLHttpRequest.prototype.open = function(method, url, ...rest) {
      if (url.includes("e43293bd67a34c9d37457957d30ba781.data.unityweb")) {
        url = mergedUrl;
      }
